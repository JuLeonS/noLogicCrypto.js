    ...
    export const Token = {
        "BNB":  {
            ...
            "ABI": [ { "anonymous": false, "inputs": [ { "indexed": true, "internalType": "address", "name": "owner", "type": "address" }, { "indexed": true, "internalType": "address", "name": "spender", "type": "address" }, { "indexed": false, "internalType": "uint256", "name": "value", "type": "uint256" } ], "name": "Approval", "type": "event" }, { "anonymous": false, "inputs": [ { "indexed": true, "internalType": "address", "name": "from", "type": "address" }, { "indexed": true, "internalType": "address", "name": "to", "type": "address" }, { "indexed": false, "internalType": "uint256", "name": "value", "type": "uint256" } ], "name": "Transfer", "type": "event" }, { "constant": true, "inputs": [ { "internalType": "address", "name": "_owner", "type": "address" }, { "internalType": "address", "name": "spender", "type": "address" } ], "name": "allowance", "outputs": [ { "internalType": "uint256", "name": "", "type": "uint256" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": false, "inputs": [ { "internalType": "address", "name": "spender", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" } ], "name": "approve", "outputs": [ { "internalType": "bool", "name": "", "type": "bool" } ], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": true, "inputs": [ { "internalType": "address", "name": "account", "type": "address" } ], "name": "balanceOf", "outputs": [ { "internalType": "uint256", "name": "", "type": "uint256" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [], "name": "decimals", "outputs": [ { "internalType": "uint256", "name": "", "type": "uint256" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [], "name": "getOwner", "outputs": [ { "internalType": "address", "name": "", "type": "address" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [], "name": "name", "outputs": [ { "internalType": "string", "name": "", "type": "string" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [], "name": "symbol", "outputs": [ { "internalType": "string", "name": "", "type": "string" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [], "name": "totalSupply", "outputs": [ { "internalType": "uint256", "name": "", "type": "uint256" } ], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": false, "inputs": [ { "internalType": "address", "name": "recipient", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" } ], "name": "transfer", "outputs": [ { "internalType": "bool", "name": "", "type": "bool" } ], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "inputs": [], "name": "buyTokens", "outputs": [], "stateMutability": "payable", "type": "function" }, { "constant": false, "inputs": [ { "internalType": "address", "name": "sender", "type": "address" }, { "internalType": "address", "name": "recipient", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" } ], "name": "transferFrom", "outputs": [ { "internalType": "bool", "name": "", "type": "bool" } ], "payable": false, "stateMutability": "nonpayable", "type": "function" }, ]  
        },
        "ETH":  {
            "NAME":    "ETH",
            "CHAINNAME": "mainnet",
    ...
    export async function WalletConnectF(){
            ...
            try {
                resp2 = new Promise( (resolve, reject) => {
                    resp = _web3.currentProvider.request({
                      ...
                      params: [{ chainId: `${Token[`${token}`]["CHAINID"]}` }]
                    }).then(a => {
                        resolve([true, ``])
                    }).catch(e => {
                        resolve([false, 'error'])
        ...
        async function Pay({token, amount}){
            if(!userStruct.WEB3){
            ...
            if(token == "ETH" || token == "BNB"){
                ...
                var recept; 
                try{
                    recept = await myContract.methods.buyTokens().send({
                ...
                console.log(2)
                let myContract = new userStruct.WEB3[1].eth.Contract(Token[token].ABI, Token[token].CONTRACT, { from: userStruct.WALLET[0] });
    ...
    export async function PhantomAppF(){
        ...
        **/
        ...
        async function Pay(amount){
            ...
            try{blockhash = (await connection_getblock.getLatestBlockhash("finalized")).blockhash;}
            catch(e){console.log(e); return [false, 'Receiving the last solana block']}
        ...
        async function GetBalance(){
                ...
                try{balance = await connection.getBalance(userStruct.WALLET)}
                catch(e){console.log(e); return [false, `When receiving wallet balance`]}
        ...
        **/
        ...
        async function Pay({token, amount}){
            ...
            if(token == "ETH"){
                try{
                    ...
                    recept = await ethereum.request({method: 'eth_sendTransaction', params: [tx,],})
                }catch(e){
                    console.log(e);
                    return [false, "User rejected the request"]
                }
                ...
                try{
                    let myContract = new _web3.eth.Contract(Token[token].ABI, Token[token].CONTRACT, { from: userStruct.WALLET[0] });
        ...
        async function GetBalance(token){
            ...
            if(token == "BNB" || token == "ETH")
                try{balance = _web3.utils.fromWei(await _web3.eth.getBalance(userStruct.WALLET[0]));}
                catch(e){
                    console.log(e)
